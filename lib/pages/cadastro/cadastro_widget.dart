...
class _CadastroWidgetState extends State<CadastroWidget> {
  ...
  void initState() {
    ...
    _model.nascimentoController ??= TextEditingController();
    _model.nascimentoFocusNode ??= FocusNode();

    _model.passwdController ??= TextEditingController();
    _model.passwdFocusNode ??= FocusNode();

    _model.confirmPasswdController ??= TextEditingController();
    _model.confirmPasswdFocusNode ??= FocusNode();
  }
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed('PagPrincipal');
                                    },
                                    child: Icon(
                              ...
                              children: [
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      width: MediaQuery.sizeOf(context).width *
                                          1.0,
                                      child: TextFormField(
                                        controller: _model.nascimentoController,
                                        ...
                                        keyboardType: TextInputType.number,
                                        validator: _model
                                            .nascimentoControllerValidator
                                            .asValidator(context),
                                        inputFormatters: [
                                          _model.nascimentoMask
                                        ],
                                      ),
                                    ),
                                  ),
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 20.0, 0.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.passwdController,
                                    focusNode: _model.passwdFocusNode,
                                    obscureText: !_model.passwdVisibility,
                                    decoration: InputDecoration(
                                      labelText: 'Senha',
                                      labelStyle: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                    ...
                                    cursorColor: Colors.black,
                                    validator: _model.passwdControllerValidator
                                        .asValidator(context),
                                    inputFormatters: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 20.0, 0.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.confirmPasswdController,
                                    focusNode: _model.confirmPasswdFocusNode,
                                    autofocus: true,
                                    obscureText:
                                        !_model.confirmPasswdVisibility,
                                    decoration: InputDecoration(
                                    ...
                                    cursorColor: Colors.black,
                                    validator: _model
                                        .confirmPasswdControllerValidator
                                        .asValidator(context),
                                    inputFormatters: [
                                      FilteringTextInputFormatter.allow(
                                          RegExp('[a-zA-Z0-9]'))
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (_model.passwdController.text !=
                                          _model.confirmPasswdController.text) {
                                      ...
                                      await UsersRecord.collection
                                          ...
                                          .update(createUsersRecordData(
                                            ...
                                            dataNasc: _model.cpfController.text,
                                            password: '',
                                          ));
